...
public class ElevatorCarriage {//OBJECT CLASS CONTAINING METHODS NEEDED FOR CARRAIGE OPERATION
	...
	public void actuateTotePickup()//ACTION METHOD   ACTUATES OBTAINING A TOTE AND PREPING FOR GETTING THE NEXT ONE (TOTE)
	{
		releaseTote();//RELEASES TOTE
		lowerCarriage();//LOWERS CARRIAGE
		Timer.delay(.75);//WAITS FOR THE CARRIAGE TO LOWER
		getTote();//GETS NEXT TOTE
		Timer.delay(.30);//WAITS FOR TOTE TO LOCK IN PLACE
	...
	public void autonTotePickUp()//ACTION METHOD  WILL PICKUP THE TOTE  FOR USE DURING AUTONOMOUS FOR EFFICIENCY
	{
		getTote();//GETS NEXT TOTE
		Timer.delay(.30);//WAITS FOR TOTE TO LOCK IN PLACE
		raiseCarriage();//RAISES CARRIAGE
	}//END PICKING UP FIRST TOTE IN AUTON
	
	public void autonCanPickUp()//ACTION METHOD  WILL PICKUP THE CAN   FOR USE DURING AUTONOMOUS FOR EFFICIENCY
	{
		getCan();//GETS CAN
		Timer.delay(.3);//WAITS FOR CAN TO LOCK INTO PLACE
		raiseCarriage();//RAISES THE CARRAIGE 
	}//END AUTON TOTE PICKUP METHOD
